...
def simple_data_entries(data_entries):
    """
    Return a lightweight version of these data entries.
    :param data_entries:
    :return: list of dictionaries
    """
    data = []
    for entry in data_entries:
        data.append(simple_data_entry(entry))
    return data


def simple_data_entry(entry):
    """
    Return a lightweight version of this data entry.
